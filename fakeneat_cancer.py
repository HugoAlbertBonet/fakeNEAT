...
class Config:
    ...
    crossovers = 1
    limit_val = 0.05                                    # Minimum error in validation for early stopping
    limit_test = 0.1                                    # If early stopping is triggered, minimum error in test to consider successful
