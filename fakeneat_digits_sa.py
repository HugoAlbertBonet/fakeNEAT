...
class ConfigNEGA:
    ...
    proportion_val = 0.4                                # Proportion of dataset used to evaluate the individuals during genetic algorithm
    hidden_layers = 3                                   # Number of hidden layers per network
    max_neurons = 150                                   # Max number of neurons per layer in inicialization
    population_size = 100                               # Size of population
    num_generations = 500                              # Max number of iterations of genetic algorithm
    mutation_rate = 0.1                                 # Proportion of individuals of population suffering mutations
    top_n = 5                                           # Number of best results to keep from disappearing
    ...
    crossovers = 10                                      # Number of pairs of solutions crossed at each generation
    limit_val = 0.3                                    # Minimum error in validation for early stopping
    limit_test = 0.3                                   # If early stopping is triggered, minimum error in test to consider successful
